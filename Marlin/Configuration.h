...
#define STRING_CONFIG_H_AUTHOR "John Folger" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION "v0.1" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 WEBSITE_URL "folgertech.com"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "FT-6 V0.1"
